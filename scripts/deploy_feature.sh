...
while [ "$#" -gt 0 ]; do
    case "$1" in
        --all-cbots)
            ...
            docker restart cbot-jp225 cbot-hk50 cbot-gbpjpy cbot-gbpusd cbot-xauusd cbot-us30 cbot-ustec cbot-de40 cbot-uk100 cbot-gbpusd-judas cbot-xauusd-judas cbot-uk100-judas cbot-ustec-judas
            shift
            ;;
        --cbot)
            shift
